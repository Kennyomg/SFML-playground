...
#include "../editor/game_state_editor.hpp"
#include "../physics/game_state_physics.hpp"
...
void GameStateStart::loadgame(std::string &msg)
{
	if(msg == "physics_game")
		this->game->pushState(new GameStatePhysics(this->game));
...
GameStateStart::GameStateStart(Game* game)
{
	...
	this->guiSystem.emplace("menu", Gui(sf::Vector2f(272, 32), 4, false, game->stylesheets.at("button"),
	{ std::make_pair("Physics are Easy!", "physics_game"), std::make_pair("Lovely animations!", "physics_game") }));
